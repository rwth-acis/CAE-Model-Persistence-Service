...
/**
 * 
 * (Data-)Class for Edges. Provides means to convert JSON to Object and Object
...
public class Edge {
	...
	private String type;
	// an edge has a label value (in comparison to a node which uses the "name"
	// value here)
	...
	public Edge(String edgeId, JSONObject jsonEdge) {
		...
		// dig deep into the object to get the value of the label..remaining
		// part of the inner objects
		// is not needed to save (since redundant information is stored there,
		// needed only for frontend
		// (synchronization) reasons)
		this.labelValue = (String) ((JSONObject) ((JSONObject) jsonEdge.get("label")).get("value")).get("value");
	...
	/**
	 * 
	 * Creates an edge from a passed on
	 * {@link i5.cae.simpleModel.edge.SimpleEdge}.
	 * 
	 * @param edge
	 *            a {@link i5.cae.simpleModel.edge.SimpleEdge}
	 * 
	 */
	...
	/**
	 * 
	 * Returns the JSON representation of this edge. This representation is
	 * rather specific to SyncMeta and should not be taken as a generic example
	 * of a JSON object representation.
	 * 
	 * @return a JSON object representing a (SyncMeta) compatible edge
	 *         representation
	 * 
	 */
	@SuppressWarnings("unchecked")
